...
from time_management.company_policy.serializers import CompanyPolicySerializer
...
def company_policy_api(request, id=None):
    if request.method == "GET":
        ...
        if id:
            try:
                ...
                serializer = CompanyPolicySerializer(obj)
            ...
            serializer = CompanyPolicySerializer(objs, many=True)
            return Response(serializer.data, status=status.HTTP_200_OK)
    ...
    if request.method == "POST":
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                {"message": "CompanyPolicy data added", "data": serializer.data},
